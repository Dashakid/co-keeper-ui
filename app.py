                ...
                with st.spinner("🔄 Sending data to backend and training model..."):
                    ...
                    if error:
                        ...
                        .dinosaur-container {
                            ...
                            bottom: 20%;
                            left: -200px;
                            animation: dinosaurRun 4.5s ease-in-out forwards;
                            z-index: 9999;
                            font-size: 80px;
                            font-weight: bold;
                        }
                        ...
                        .dinosaur-leg {
                            display: inline-block;
                            animation: legSwing 0.4s ease-in-out infinite;
                        ...
                        .dust {
                            ...
                            bottom: -20px;
                            font-size: 40px;
                            animation: dust 0.6s ease-out;
                            opacity: 0;
                        }
                        
                        .dust1 { animation-delay: 0s; }
                        .dust2 { animation-delay: 0.15s; }
                        .dust3 { animation-delay: 0.3s; }
                        </style>
                        <div class="dinosaur-container">
                            <div class="dinosaur-body">
                                🦕
                            </div>
